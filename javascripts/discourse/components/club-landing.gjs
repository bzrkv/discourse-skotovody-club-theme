...
const PERSONAS = [
  ...
  { name: "Ветеринарный врач", sub: "Региональный или частный", icon: "shield-halved", tone: "terracotta", text: "Делитесь протоколами вакцинации, отслеживаете вспышки, советуетесь по сложным случаям." },
...
const FAQ = [
  {
    q: "Это платно?",
    a: "Да, членство в Клубе платное — 15 000 ₽/год для фермеров и КФХ (Действительный) или 30 000 ₽/год для поставщиков (Ассоциированный). Бесплатно только Почётное членство — для экспертов и студентов по приглашению — и открытый раздел «Новости», доступный всем без регистрации.",
  },
  {
    q: "Меня могут не принять?",
    a: "Да, если по профилю не видно связи с мясным скотоводством — например, нет хозяйства, специализации или сайта/инстаграма с фотографиями работы. Мы не оцениваем по «уровню», но хотим убедиться, что заходит человек из отрасли, а не реклама или случайный посетитель. После заявки админ может задать пару уточняющих вопросов в личке.",
  },
  {
    q: "Можно ли продавать скот в клубе?",
    a: "Да — частные объявления о продаже скота, техники и кормов размещайте в разделе «Купи-продай» внутри Клуба. Постоянный каталог хозяйств с витриной и аукционами — на skotovody.com. Оба канала работают вместе: Клуб для прямого общения с покупателем, skotovody.com для постоянной продажи.",
  },
  {
